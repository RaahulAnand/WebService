...
<body id='home-page'>
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <div id="pageNavbarRight">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="quote.html" class="btn btn-info">
      	Create a Need
      </a>
                        </li>
    ...
    <div id="page-wrapper" style="background-color: white;">
		...
		$sql="SELECT pname,brand,catogery,date FROM quetation where Email = '$eid'";
 ...
 <?php
							while($result=mysqli_fetch_array($resource))
								{
$sql1="SELECT * FROM sellerques where buyemail = '$eid' and pname ='$result[0]'";
$results1=mysqli_query($con,$sql1);
$count1=mysqli_num_rows($results1);
								echo "<tr>
								<td><a href='bidviews.php?pname=".$result[0]. "&brand=".$result[1]."'>".$result[0]."</td>
								<td>".$result[1]."</td>
                                <td>".$result[2]."</td>
								<td>".$result[3]."</td>
								<td>".$count1."</td>
